...
The rules in SKILL.md constrain everything here — in particular rule 1 (never invent) and rule
13 (the say-it-out-loud test), which between them kill most of the questions these techniques
will suggest to you.
